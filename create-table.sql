CREATE TABLESPACE PUPILSTABLE
    DATAFILE 'PATH' SIZE 50M
    AUTOEXTEND ON NEXT 10M MAX SIZE 200M
CREATE TABLESPACE TEACHERSTABLE
    DATAFILE 'PATH' SIZE 50M
    AUTOEXTEND ON NEXT 10M MAX SIZE 200M
CREATE TABLESPACE REWARDS
    DATAFILE 'PATH' SIZE 30M
    AUTOEXTEND ON NEXT 5M MAX SIZE 100M
